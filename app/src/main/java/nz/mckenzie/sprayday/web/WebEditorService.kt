...
class WebEditorService : Service() {
     ...
     *
     * The picture is the phone's own, edge and all: a page asking for a name gets the marker the
     * phone's map draws under that name. The edge scales with the picture - one asked for at 44 pixels
     * gets an edge twice the width of one asked for at 22, because it is the same marker drawn bigger
     * rather than a smaller marker with a fat ring around it.
     */
